...
def predict_depression():
    ...
    if result == 0:
        ...
        return render_template('depression_test.html', result="not spam", feedback = input_sms)
    
    else:
        return render_template('depression_test.html', result="spam", feedback = input_sms)
